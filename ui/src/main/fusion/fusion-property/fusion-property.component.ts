...
@Component({
  selector: 'app-fusion-property',
  templateUrl: './fusion-property.component.html',
  styleUrls: ['./fusion-property.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FusionPropertyComponent implements OnInit {
  id: string = '';
  type: string = '';
