...
@Component({
  selector: 'app-fusion-value',
  templateUrl: './fusion-value.component.html',
  styleUrls: ['./fusion-value.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FusionValueComponent implements OnInit {
  id: string = '';
  type: string = '';
