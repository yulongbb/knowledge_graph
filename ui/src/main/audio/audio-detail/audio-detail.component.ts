...
export class AudioDetailComponent implements OnInit {
  ...
  constructor(
    ...
    this.activatedRoute.paramMap.subscribe((x: ParamMap) => {
      ...
      this.data = this.nodeService.getLinks(1, 20, this.id, { schema: '35b7855a-0b3a-fba8-2771-daa305523feb' }).pipe(
  ...
  backClick() {
    this.router.navigate([`/index/audio/${this.knowledge}`], { replaceUrl: true });
